    ...
    view! {
        <section class="rounded-panel border border-border bg-surface shadow-panel">
            <header class="flex min-h-14 items-center justify-between border-b border-border px-4 sm:px-5">
                ...
                <span class="rounded border border-border bg-surface-elevated px-2 py-1 text-[0.625rem] font-medium uppercase tracking-wider text-text-muted-readable">"Foundation"</span>
            </header>
